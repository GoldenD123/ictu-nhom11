...
export const MOCK_JOBS: Job[] = [
  {
    ...
    type: "Full-time",
    description:
      "Chúng tôi đang tìm kiếm một kỹ sư Frontend dày dạn kinh nghiệm với React và TypeScript để xây dựng các sản phẩm AI tiên tiến.",
    requirements: [
      "5+ years React",
  ...
  },
  {
    ...
    type: "Remote",
    description:
      "Tham gia đội ngũ thiết kế của chúng tôi để tạo ra những trải nghiệm người dùng tuyệt vời nhất cho thị trường toàn cầu.",
    requirements: [
      "Figma mastery",
      "Portfolio required",
      "User Research",
  ...
  },
  {
    ...
    type: "Full-time",
    description:
      "Xây dựng hệ thống microservices hiệu năng cao phục vụ hàng triệu người dùng.",
  ...
  },
  {
    ...
    type: "Part-time",
    description:
      "Phát triển các chiến dịch marketing số và quản lý cộng đồng cho thương hiệu bền vững.",
